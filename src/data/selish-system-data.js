...
const ky = createPlanetData({
    ...
    children: [
        createMoonData({
            ...
            orbitalRadius : 12,
            orbitalEccentricity : 0.2671,
            orbitalIncline : new THREE.Vector2(1.284, 27),
            orbitalSpeed : 0.968,
            orbitStart: -321,
        ...
        createMoonData({
            ...
            orbitalRadius : 25,
            orbitalEccentricity : 0.2671,
            orbitalIncline : new THREE.Vector2(-1.345, 53),
            orbitalSpeed : 0.968,
            orbitStart: 275,
            description : `This is one of Ky's 4 known moons.`,
            coppermind : 'https://coppermind.net/wiki/Selish_system'
        ...
        createMoonData({
            ...
            orbitalRadius : 34,
            orbitalEccentricity : 0.2671,
            orbitalIncline : new THREE.Vector2(1.5872, 148),
            orbitalSpeed : 0.968,
            orbitStart: 12,
            description : `This is one of Ky's 4 known moons.`,
            coppermind : 'https://coppermind.net/wiki/Selish_system'
        ...
        createMoonData({
            ...
            orbitalRadius : 48,
            orbitalEccentricity : 0.2671,
            orbitalIncline : new THREE.Vector2(1.8542, 94),
            orbitalSpeed : 0.968,
            orbitStart: 234,
            description : `This is one of Ky's 4 known moons.`,
            coppermind : 'https://coppermind.net/wiki/Selish_system'
...
const ralen = createPlanetData({
    ...
    children: [
        createMoonData({
            ...
            orbitalRadius : 47,
            orbitalEccentricity : 0.2671,
            orbitalIncline : new THREE.Vector2(1.3653, 27),
            orbitalSpeed : 0.968,
            orbitStart: -321,
        ...
        createMoonData({
            ...
            orbitalRadius : 59,
            orbitalEccentricity : 0.2671,
            orbitalIncline : new THREE.Vector2(-1.1234, 53),
            orbitalSpeed : 0.968,
            orbitStart: 275,
            description : `This is one of Ralen's 5 known moons.`,
            coppermind : 'https://coppermind.net/wiki/Selish_system'
        ...
        createMoonData({
            ...
            orbitalRadius : 76,
            orbitalEccentricity : 0.2671,
            orbitalIncline : new THREE.Vector2(2.345, 148),
            orbitalSpeed : 0.968,
            orbitStart: 12,
            description : `This is one of Ralen's 5 known moons.`,
            coppermind : 'https://coppermind.net/wiki/Selish_system'
        ...
        createMoonData({
            ...
            orbitalRadius : 87,
            orbitalEccentricity : 0.2671,
            orbitalIncline : new THREE.Vector2(3.5423, 94),
            orbitalSpeed : 0.968,
            orbitStart: 234,
            description : `This is one of Ralen's 5 known moons.`,
            coppermind : 'https://coppermind.net/wiki/Selish_system'
        ...
        createMoonData({
            ...
            orbitalRadius : 98,
            orbitalEccentricity : 0.2671,
            orbitalIncline : new THREE.Vector2(3.234, 94),
            orbitalSpeed : 0.968,
            orbitStart: 234,
            description : `This is one of Ralen's 5 known moons.`,
            coppermind : 'https://coppermind.net/wiki/Selish_system'
